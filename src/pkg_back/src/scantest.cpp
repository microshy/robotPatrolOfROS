...
void Scan2::scanCallBack(const sensor_msgs::LaserScan::ConstPtr& scan2)
{
    ...
    scan.ranges[180] = scan2->ranges[180];
    scan.ranges[200] = scan2->ranges[200];
    scan.ranges[10]  = scan2->ranges[10];    //左側 90
    scan.ranges[370] = scan2->ranges[370];   //右側 90
    scan.ranges[190] = scan2->ranges[190];
