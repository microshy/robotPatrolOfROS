...
int red_count=0;
int yellow_count=0;
const char* file="/home/user/log/record/alarm.txt";
const char* file_odom="/home/user/log/record/odom.txt";
const char* file_odom2="/home/user/log/record/raw_odom.txt";
class robotState
{
public:
    int count = 0;                     //测试用
    ...
    void statecallback7(const communication::state::ConstPtr& msg7)
    {
        //获取旋转运控板的信息
        if(!state[83])
        {
