...
const char* file   = "/home/user/log/record/odom_prediction.txt";
const char* file1  = "/home/user/log/record/turn.txt";
const char* file_odom  = "/home/user/log/record/odom_increase.csv";
const char* file_odom_str = "/home/user/log/record/odom_str_increase.csv";
// velocity
double vx;
double vy;
double vth;
